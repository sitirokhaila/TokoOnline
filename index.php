...
<body>
			...
			<div class="box">
				...
				?>
					<a href="produk.php?kat=<?php echo $k['category_id'] ?>">
						<div class="col-5">
							<img src="img/icon-ktgr.png" width="50px" style="margin-bottom:5px;">
	...
	<div class="section">
		<div class="container">
			...
			<div class="box">
				<?php 
					$produk = mysqli_query($conn, "SELECT * FROM tb_product WHERE product_status = 1 ORDER BY product_id DESC LIMIT 16");
